 ...
 * @Program ：vevor-tools
 * @Author ：Li Hui
 * @Date ：Created in 2020/10/23 9:24
 * @Version ：1.0.1
 */
public abstract class AbstractImageSitemapUrlOptions<U extends WebSitemapUrl,
        THIS extends AbstractImageSitemapUrlOptions<U,THIS>>{
    Date lastMod;
    ...
    public AbstractImageSitemapUrlOptions(String url, Class<U> clazz) throws MalformedURLException {
        this(new URL(url), clazz);
    }

    public AbstractImageSitemapUrlOptions(URL url, Class<U> clazz) {
        if (url == null){
